...
// Step 21 - Using the story plan, update nextStory() to change the storyNumber depending on the choice made by the user. e.g. if choiceNumber was equal to 1 and the storyNumber is 0, the storyNumber should become 2.
  void nextStory(int choice) {
    if (choice == 2 && storyNumber == 0)
      storyNumber = 1;
    else if (choice == 1 && storyNumber == 0)
      storyNumber = 2;
    else if (choice == 1 && storyNumber == 1)
      storyNumber = 2;
    else if (choice == 2 && storyNumber == 1)
      storyNumber = 3;
    else if (choice == 2 && storyNumber == 2)
      storyNumber = 4;
    else if (choice == 1 && storyNumber == 2)
      storyNumber = 5;
  ...
  bool buttonShouldBeVisible() {
    return _storyNumber == 1 || _storyNumber == 2 || _storyNumber == 0;
  }
}
